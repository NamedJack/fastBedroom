...
public class MyViewHolder extends RecyclerView.ViewHolder {
    ...
    public static MyViewHolder createViewHoler(Context context, View itemView) {
        MyViewHolder holder = new MyViewHolder(context, itemView);
        return holder;
    }

    public static MyViewHolder createViewHoler(Context context, ViewGroup parent, int layoutId) {
